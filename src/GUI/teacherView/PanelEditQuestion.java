...
public class PanelEditQuestion extends javax.swing.JPanel {
    ...
    public PanelEditQuestion(QuestionDTO question) {
        initComponents();
    ...
    private void setData() {
        ...
        items.add(question.getSubjectName());
        cbxSubjects.setData(items);
        cbxSubjects.setEnabled(false);
        cbxSubjects.setBackground(Color.WHITE);
        cbxSubjects.setForeground(Color.red);
        txtQuesiton.setText(question.getQuestionText());
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        q.setQuestionText(txtQuesiton.getText());
