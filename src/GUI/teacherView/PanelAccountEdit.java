...
public class PanelAccountEdit extends javax.swing.JPanel {
    ...
    public PanelAccountEdit(AccountDTO account, TeacherDTO teacher) {
        initComponents();
    ...
    public void setInfo() {
        ...
        txtName.setText(teacher.getFirstName() + " " + teacher.getLastName());
        String date_string = teacher.getBirthday();
        SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
        Date date = null;
        try {
            date = formatter.parse(date_string);
        } catch (ParseException ex) {
            Logger.getLogger(GUI.studentView.PanelAccountEdit.class.getName()).log(Level.SEVERE, null, ex);
        }
        calendar.setDate(date);
        cbxGender.setSelectedItem(teacher.getGender());
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if (isValidData()) {
            ...
            updatedTeacher.setAccountId(account.getAccounId());
            updatedTeacher.setTeacherId(teacher.getTeacherId());
            updatedTeacher.setFirstName(Str.getFirstWord(txtName.getText()));
            updatedTeacher.setLastName(Str.getTheRest(txtName.getText()));
            Date selectedDate = calendar.getDate();
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
            String formattedDateTime = dateFormat.format(selectedDate);
            updatedTeacher.setBirthday(formattedDateTime);
            updatedTeacher.setGender(cbxGender.getSelectedItem().toString());
            updatedTeacher.setPhoneNumber(txtPhone.getText());
            updatedTeacher.setEmail(txtEmail.getText());
            account.setPassword(password);
            if ((new TeacherBUS()).update(updatedTeacher) || (new AccountBUS()).update(account)) {
