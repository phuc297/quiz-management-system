...
public class PanelAddExam extends javax.swing.JPanel {
    ...
    public PanelAddExam(int teacherId) {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtExamName.setText("jTextField1");
        txtExamName.setPreferredSize(null);
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(txtExamName, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(cbxNumberQuestions, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void cbxSubjectsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxSubjectsActionPerformed
        ...
        ArrayList<ClassDTO> classes = classBUS.getAllOfTeacher(teacherId);
        if (classes.size() != 0) {
            for (ClassDTO i : classes) {
                if (i.getSubjectId() == s.getSubjectId()) {
                    items.add(i);
                }
            }
            if (items.size() != 0) {
